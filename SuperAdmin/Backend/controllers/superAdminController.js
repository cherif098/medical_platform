...
export const addHospital = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ success: false, message: "Failed to add hospital", error });
  }
};
...
export const getHospitals = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ success: false, message: "Failed to fetch hospitals", error });
  }
};
...
export const getHospital = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ success: false, message: "Failed to fetch hospital", error });
  }
};
...
export const removeHospital = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ success: false, message: "Failed to delete hospital", error });
  }
};
