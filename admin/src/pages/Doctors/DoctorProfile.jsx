      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
        <div className="md:flex">
          ...
          <div className="p-8 w-full">
            ...
            <p className="text-3xl font-bold text-gray-900 mb-2">{profileData.NAME}</p>
            ...
            <div className="bg-gray-50 p-4 rounded-lg mb-6">
              ...
              <p className="text-gray-600">{profileData.ADRESS_1}</p>
              <br/>
              <p className="text-gray-600">{profileData.ADRESS_2}</p>
            </div>
            ...
            <button className="w-full sm:w-auto px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors duration-200 shadow-md">
              Edit
            </button>
          </div>
        </div>
